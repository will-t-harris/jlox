...
class Parser {
    ...
    // a function can also be a method on a class, hence the kind parameter
    ...
    private Expr finishCall(Expr callee) {
        ...
        // if right paren isn't next, then we have arguments to handle
        if (!check(RIGHT_PAREN)) {
            do {
        ...
        // we keep a reference to the closing parenthesis to help with reporting
        // runtime errors caused by function calls
